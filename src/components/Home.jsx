    ...
    <div name="home" className="h-screen w-full bg-gradient-to-b from-black via-black to-gray-800">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
            <div className="flex flex-col justify-center h-full">
                <h2 className="text-3xl sm:text-7xl font-bold text-white">Hi! I'm Deepak juneja</h2>
                <p className="text-gray-500 py-4 max-w-md">
                Web development and programable stuff are my areas of interest as a computer science student. <br />
                Contact me through my social media links and let's connect.
                </p>
                <div>
